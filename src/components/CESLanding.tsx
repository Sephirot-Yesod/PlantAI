  ...
  return (
    <>
          ...
          <div className="w-full max-w-[1400px]">
            ...
            <div className="grid grid-cols-2 gap-6 lg:gap-8">
                ...
                <motion.div
                  ...
                  className="bg-black/40 backdrop-blur-sm border border-white/10 rounded-2xl p-6 sm:p-8"
                >
                  <h2 className="text-3xl sm:text-4xl font-black text-white mb-2">Cocreate with Us?</h2>
      ...
      <section className="md:hidden bg-[#0a0a0a] px-4 py-10">
        ...
        >
          <h2 className="text-3xl font-black text-white mb-2 text-center">Cocreate with Us?</h2>
