  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a]">
      ...
      <section className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 lg:px-12 text-center w-full">
          ...
          >
            ...
            <span className="bg-gradient-to-r from-[#00e5d0] via-[#00c4b0] to-[#00a896] bg-clip-text text-transparent">
              Better Interact
            </span>{" "}
            With Plants
          </motion.h1>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-4">
              Two Core <span className="text-[#00e5d0]">Pillars</span>
            </h2>
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-r from-[#00e5d0]/5 via-transparent to-[#00c4b0]/5" />
        </div>
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          >
            <blockquote className="space-y-8 text-xl md:text-2xl text-white/80 leading-relaxed">
              ...
              <p>
                But a plant&apos;s life is decided in the moment it touches earth and sends down its first root—born here, grown here. It can&apos;t escape. So it survives by engaging more deeply with what&apos;s around them: sunlight, rain, soil, wind—adjusting, adapting, and solving problems where they stand. That&apos;s a kind of <span className="text-[#00e5d0] font-semibold">intelligence that belongs to plants</span>.
              </p>
              <p>
                Maybe if humans want to live better with Earth, we need to understand that kind of intelligence more. Because measured against the vastness of the cosmos, this planet is not just home—it is the <span className="text-[#00e5d0] font-semibold">only shore our fragile species can stand on</span>.
              </p>
            </blockquote>
          </motion.div>
        </div>
      ...
      <section className="py-24 bg-[#0d0d0d]">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-4">
              Our <span className="text-[#00e5d0]">Journey</span>
            </h2>
            <p className="text-white/50 max-w-2xl mx-auto">
          ...
          <div className="relative">
            {/* Timeline line */}
            <div className="absolute left-8 lg:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-[#00e5d0]/50 via-[#00e5d0]/20 to-transparent" />
            ...
            <div className="space-y-12">
              {timeline.map((item, index) => (
                ...
                >
                  {/* Dot */}
                  <div className="absolute left-8 lg:left-1/2 w-4 h-4 rounded-full bg-[#00e5d0] transform -translate-x-1/2 shadow-lg shadow-[#00e5d0]/50" />

                  {/* Content */}
                  <div className={`ml-20 lg:ml-0 lg:w-1/2 ${index % 2 === 0 ? "lg:pr-16 lg:text-right" : "lg:pl-16"}`}>
                    <span className="text-[#00e5d0] font-extrabold text-xl">{item.year}</span>
      ...
      <section className="py-24">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-4">
              What We <span className="text-[#00e5d0]">Stand For</span>
            </h2>
            <p className="text-white/50 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6, delay: index * 0.1 }}
                className="group p-8 bg-[#141414] rounded border border-white/5 hover:border-[#00e5d0]/30 transition-all text-center"
              >
                <div className="w-3 h-3 rounded-full bg-[#00e5d0] mx-auto mb-6 group-hover:scale-150 transition-transform" />

                <h3 className="text-lg font-extrabold text-white mb-3 group-hover:text-[#00e5d0] transition-colors">
                  {value.title}
                </h3>
      ...
      <section className="py-24 bg-gradient-to-b from-[#0d0d0d] to-[#0a0a0a]">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 text-center">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#00e5d0]/10 border border-[#00e5d0]/20 mb-8">
              <span className="w-2 h-2 rounded-full bg-[#00e5d0] animate-pulse" />
              <span className="text-sm text-[#00e5d0] font-medium">
                Join the Movement
              </span>
            </div>
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-6">
              ...
              <br />
              <span className="text-[#00e5d0]">Plant Relationship?</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/solutions"
                className="bg-gradient-to-r from-[#00e5d0] to-[#00c4b0] text-black px-8 py-4 rounded font-semibold inline-flex items-center justify-center gap-2 hover:shadow-lg hover:shadow-[#00e5d0]/25 transition-all"
              >
                Explore Products →
              </Link>
              <Link
                href="/contact"
                className="border border-white/20 text-white px-8 py-4 rounded font-medium inline-flex items-center justify-center gap-2 hover:border-[#00e5d0]/50 hover:bg-[#00e5d0]/5 transition-all"
              >
                Get in Touch
              </Link>
            </div>
